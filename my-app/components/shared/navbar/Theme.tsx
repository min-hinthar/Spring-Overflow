...
const Theme = () => {
  ...
  <MenubarMenu>
    ...
    <MenubarContent className='absolute bg-light-900 right-[-3rem] mt-3 min-w-[120px] rounded border py-2 dark:border-dark-400 dark:bg-dark-300'>
        {themes.map((item) => (
            <MenubarItem 
                key={item.value}
                className='flex items-center gap-4 px-2.5 py-2 focus:bg-light-700 dark:focus:bg-dark-400 cursor-pointer'
                onClick={() => {
                    setMode(item.value);
