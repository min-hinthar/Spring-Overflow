...
const NavContent = () => {
    ...
    return (
        <section className='flex flex-col gap-2 pt-10 mb-5'>
...
const MobileNav = () => {
  return (
    <Sheet>
        ...
        >
            <Image 
                src='/assets/images/springOverflow.png' 
                width={50}
                height={50}
                alt='Spring Overflow Logo'
            />
            <p className='h2-bold text-dark-100_light900 font-spaceGrotesk dark:text-light-900 max-sm:hidden'>
                Spring <span className='text-primary-500'> Overflow </span>
            </p>
        </Link>
                    ...
                    <SheetClose asChild>
                        <Link href='/sign-in'>
                            <Button className='small-medium btn-secondary min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none'>
                                <span className='primary-text-gradient font-bold'>Login</span>
                            </Button>
                        </Link>
                    </SheetClose>
